...
const DATA = {
	...
	"Darls Coy": ["Дарлс Коу", 0, 30, 1, 0, 0, 0],
	#Охранник в Банке
	"Bantonio Anderas": ["Бантонио Андерас", 1, 30, 5, 0, 0, 0],
	#Бабушка сканадлистка, которая хочех всех доканать
	"Barlo Cenetton": ["Барло Сенеттон", 0, 99, 4, 0, 2, 1],
