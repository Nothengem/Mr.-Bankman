...
const DATA = {
	...
	"TutorLev1Card31" : 
		["Tutorial",
		"Mr. Bankman", 
		"АХ ДА! Заработная плата в сделку не входила. А теперь за работу! И не смей уходить с работы раньше окончания [wave amp=15 freq=5][color=#d7b914]рабочего дня[/color][/wave]!", #что говорит 2
		"Mr. Bankman",
		"Какого...?",
		"Ты серьёзно?",
		0, 0, 0, 0,
	...
	"TutorLev6Card1" : 
		["Tutorial",
		"Mr. Bankman", 
		"Я хочу тебя кое с кем познакомить! Это Шихаэль Мумахер! Он специалист по доставке!", #что говорит 2
		"Mr. Bankman",
		"От него пахнет алкоголем...",
		"Рад знакомству!",
		0, 0, 0, 0,
		0, 0, 0, 0, 
		"TutorLev6Card2", "TutorLev6Card2",
		"None",
		0],
	...
	"TutorLev6Card2" : 
		["Tutorial",
		"Mr. Bankman", 
		"Он страдает алкоголизмом, поэтому при каждой его поездке ты будешь сопровождать его как штурман! Правда здорово?", #что говорит 2
		"Mr. Bankman",
		"Может лучше уволить его?",
		"Может лучше я поведу машину?",
		0, 0, 0, 0,
		0, 0, 0, 0, 
		"TutorLev6Card3", "TutorLev6Card3",
		"None",
		0],
	...
	"TutorLev6Card3" : 
		["Tutorial",
		"Mr. Bankman", 
		"И по счасливому совпадению его отец наш главный инвестор! И мы помогаем ему научиться самостоятельной жизни!", #что говорит 2
		"Mr. Bankman",
		"Теперь я вижу, что уволить его нельзя...",
		"И видимо папаша должен думать, что у нас получается ему помочь...",
		0, 0, 0, 0,
		0, 0, 0, 0, 
		"TutorLev6Card4", "TutorLev6Card4",
		"None",
		0],
	...
	"TutorLev6Card4" : 
		["Tutorial",
		"Shihael Mumaher", 
		"Здравствуйте! ИК! Поехали доставлять кредитные деньги.... ИК! Одному важному клиенту!", #что говорит 2
		"Шихаэль Мумахер",
		"Можно мне противогаз...",
		"Надеюсь суммы, что мы везё хватит, чтобы компенсировать аварии...",
		0, 0, 0, 0,
		0, 0, 0, 0, 
		"Random", "Random",
		"Ivent",
