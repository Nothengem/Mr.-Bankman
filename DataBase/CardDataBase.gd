...
#		Ревизор спросил, улыбаясь:
#		- Сколько будет дважды два?
#		А не понимающий юмора директор, поняв это как намек
#		на несуразности в бухгалтерских счетах, сразу во всем признался...
		
		
	"TutorLev6Card1" : 
		["Tutorial",
		"Mr. Bankman", 
		"Это катастрофа! Он уже стоит у двери!", #что говорит 2
		"Mr. Bankman",
		"Давайте закроемся... а от кого?",
		"Вижу лысого мужчину... боитесь, что это заразно?",
		0, 0, 0, 0,
		0, 0, 0, 0, 
	...
	"TutorLev6Card2" : 
		["Tutorial",
		"Mr. Bankman", 
		"Шутки в сторону юноша, это ревизор из Центрального Государственного Банка! Он пришел с проверкой! И отказывать ему крайне нежелательно!", #что говорит 2
		"Mr. Bankman",
		"Мне позвать охарану?",
		"Мне сжечь все документы?",
		0, 0, 0, 0,
		0, 0, 0, 0, 
	...
	"TutorLev6Card3" : 
		["Tutorial",
		"Mr. Bankman", 
		"Уже поздно! В общем у нас не всё впорядке с документами, но он может ничего и не найти... полагаемся на удачу...", #что говорит 2
		"Mr. Bankman",
	...
	"TutorLev6Card4" : 
		["Tutorial",
		"Mr. Bankman", 
		"Добрый день! Пойдем по обычному сценарию. Я проверяю документы, нахожу противоречия и выписываю штрафы. И побыстрее, я спешу!", #что говорит 2
		"Mr. Bankman",
		"Приходите потом! У нас обеденный перерыв!",
		"Конечно, я сеейчас вам всё предоставлю",
		0, 0, -60, 0,
		0, 0, 0, 0, 
		"Random", "Ivent",
		"CentralBankDice1",
