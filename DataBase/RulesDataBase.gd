...
const DATA = {
	"SpisokVsego": #ключ:
		...
		21, 65, #возраст (Банк),
		["США", "Франция", "Великобритания", "Индия", "Испания", "Южная Корея", "Япония", "Китай", "Египет", "Канада", "Германия", "Россия", "Греция", "Бразилия", "Австралия", "Южная Африка", "Новая Зеландия", "Италия"], #страна(Банк и Финансы )
		"Хорошая", #история(Финансы)
		"Чист", #лист(Банк)
		["Высокий", "Средний"], #кредитный рейтинг(Финансы)
		["На инвестиции"], #запрет на работу с такими клиентами
		],
	"DayTest": [["Женщины"], 21, 65, ["Низкобритания", "Индая"], "Средняя", "Чист", ["Низкий"], ["На инвестиции"],],
	"LVL1": [null, 0, 0, null, null, null, null, null,],
